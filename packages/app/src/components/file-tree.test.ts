...
beforeAll(async () => {
  ...
  mock.module("@nexus-code/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@nexus-code/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@nexus-code/ui/icon", () => ({ Icon: () => null }))
  mock.module("@nexus-code/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
