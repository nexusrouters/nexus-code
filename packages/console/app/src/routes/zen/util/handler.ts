...
import { and, Database, eq, isNull, lt, or, sql } from "@nexus-code/console-core/drizzle/index.js"
import { KeyTable } from "@nexus-code/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@nexus-code/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@nexus-code/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@nexus-code/console-core/util/date.js"
import { Identifier } from "@nexus-code/console-core/identifier.js"
import { Billing } from "@nexus-code/console-core/billing.js"
import { Actor } from "@nexus-code/console-core/actor.js"
import { WorkspaceTable } from "@nexus-code/console-core/schema/workspace.sql.js"
import { ZenData } from "@nexus-code/console-core/model.js"
import { Subscription } from "@nexus-code/console-core/subscription.js"
import { BlackData } from "@nexus-code/console-core/black.js"
import { UserTable } from "@nexus-code/console-core/schema/user.sql.js"
import { ModelTable } from "@nexus-code/console-core/schema/model.sql.js"
import { ProviderTable } from "@nexus-code/console-core/schema/provider.sql.js"
...
import { LiteData } from "@nexus-code/console-core/lite.js"
import { Resource } from "@nexus-code/console-resource"
...
export async function handler(
  ...
  try {
    ...
    logger.metric({
      ...
      request: requestId,
      client: ocClient,
      ...(model === "nexus-v2-pro-free" && JSON.stringify(body).length < 1000 ? { payload: JSON.stringify(body) } : {}),
    })
