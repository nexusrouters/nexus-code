...
import { IconMiniMax, IconNexus, IconZai, IconAlibaba } from "~/component/icon"
...
const models = [
  ...
  { name: "Nexus-V2-Pro", provider: "Nexus Code" },
  { name: "Nexus-V2-Omni", provider: "Nexus Code" },
...
function LimitsGraph(props: { href: string }) {
  ...
  const graph = [
    ...
    { id: "nexus-v2-pro", name: "Nexus-V2-Pro", req: 1290, d: "150ms" },
