import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@nexus-code/sdk/v2"
import { SessionTurn } from "@nexus-code/ui/session-turn"
import { SessionReview } from "@nexus-code/ui/session-review"
import { DataProvider } from "@nexus-code/ui/context"
import { FileComponentProvider } from "@nexus-code/ui/context/file"
import { WorkerPoolProvider } from "@nexus-code/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@nexus-code/ui/logo"
import { IconButton } from "@nexus-code/ui/icon-button"
import { ProviderIcon } from "@nexus-code/ui/provider-icon"
import { iife } from "@nexus-code/shared/util/iife"
import { Binary } from "@nexus-code/shared/util/binary"
import { NamedError } from "@nexus-code/shared/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@nexus-code/ui/tabs"
import { MessageNav } from "@nexus-code/ui/message-nav"
import { FileSSR } from "@nexus-code/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@nexus-code/ui/pierre/worker").then((m) => ({
