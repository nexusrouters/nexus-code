...
describe("tool.registry", () => {
  it.live("loads tools from .nexuscode/tool (singular)", () =>
    provideTmpdirInstance((dir) =>
      Effect.gen(function* () {
        const opencode = path.join(dir, ".nexuscode")
  ...
  it.live("loads tools from .nexuscode/tools (plural)", () =>
    provideTmpdirInstance((dir) =>
      Effect.gen(function* () {
        const opencode = path.join(dir, ".nexuscode")
