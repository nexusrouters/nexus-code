...
// Provider IDs served by the Nexus model gateway. Its error bodies carry
...
const MIMO_GATEWAY_PROVIDERS = new Set(["xiaomi", "nexus"])

// Nexus gateway error.code values worth relabeling: moderation (421) and
...
function message(providerID: ProviderID, e: APICallError) {
  return iife(() => {
    // Nexus gateway: relabel known block codes and surface error.param (the real
