 ...
 * TODO: lift to nexuscode.json config (e.g. actor.maxPreReact) and add per-hook
  ...
  Effect.gen(function* () {
    ...
    const forkWork = (input: {
      ...
      Effect.gen(function* () {
        ...
        // ignored: not reachable in normal usage (nexus run sets no such rule, spawn doesn't
