...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Al usar NexusCode, aceptas nuestros ",
  ...
  "tui.tips.formatter": "NexusCode formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.zen":
    "Usa {highlight}/connect{/highlight} con Nexus Code para modelos seleccionados y probados",
  "tui.tips.agents_md":
  ...
  "tui.toast.update_available.success": "Se actualizó a NexusCode v{{version}}. Por favor reinicie la aplicación.",
  ...
  "trust.capabilities": "Nexus Code podrá leer, editar y ejecutar archivos aquí.",
