export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using NexusCode, you agree to our ",
  ...
  "tui.tips.config_files":
    "Create {highlight}nexuscode.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/nexuscode/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "NexusCode auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.nexuscode/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.nexuscode/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "NexusCode auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "NexusCode uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.nexuscode/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.nexuscode/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent NexusCode from reading sensitive files",
  "tui.tips.run": "Use {highlight}nexus run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}nexus --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}nexus run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}nexus serve{/highlight} for headless API access to NexusCode",
  "tui.tips.attach_server": "Use {highlight}nexus run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}nexus upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}nexus auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}nexus agent create{/highlight} for guided agent creation",
  "tui.tips.github_trigger": "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "tui.tips.github_install": "Run {highlight}nexus github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.nexuscode/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}nexus debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with Nexus Code for curated, tested models",
  ...
  "tui.toast.update_available.success": "Successfully updated to NexusCode v{{version}}. Please restart the application.",
  ...
  "tui.voice.error.no_auth": "Please log in to Nexus first",
  ...
  "tui.dialog.login.nexus_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.nexus_free.success": "Nexus Auto (free) is ready — default model set to nexus/nexus-auto",
  "tui.dialog.login.nexus_free.unavailable": "Nexus Auto (free) provider not loaded",
  "cli.providers.select": "Select provider",
  "cli.providers.other": "Other provider",
  "cli.providers.nexus.recommended_hint": "recommended",
  "cli.providers.nexus_free.hint": "Anonymous free channel / nexus-auto",
  "cli.providers.nexus_free.verifying": "Verifying Nexus Auto (free) channel...",
  "cli.providers.nexus_free.ready": "Nexus Auto (free) channel ready",
  "cli.providers.nexus_free.failed": "Nexus Auto (free) verification failed",
  "cli.providers.nexus_free.default_set": "Default model set to nexus/nexus-auto (1M context, free)",
  "cli.providers.nexus_free.usage_hint": "No login required — just run nexus. For paid/premium models, choose Nexus browser login instead.",
  "cli.providers.nexus_login.decrypt_retry": "Decryption failed, please retry ({remaining} attempts left)",
  "cli.providers.nexus_login.decrypt_exhausted": "Decryption failed, max retries reached",
  ...
  "trust.capabilities": "Nexus Code will be able to read, edit, and execute files here.",
