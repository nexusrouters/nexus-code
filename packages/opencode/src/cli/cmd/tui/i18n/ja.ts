...
export const dict = {
  ...
  "tui.home.agreement.prefix": "NexusCode をご利用いただくことで、",
  ...
  "tui.tips.formatter": "NexusCode は prettier、gofmt、ruff などでファイルを自動整形します",
  ...
  "tui.tips.zen": "Nexus Code と組み合わせて {highlight}/connect{/highlight} で厳選されたモデルを使えます",
  ...
  "tui.toast.update_available.success": "NexusCode v{{version}} に更新しました。アプリケーションを再起動してください。",
  ...
  "trust.capabilities": "Nexus Code はここでファイルの読み取り、編集、実行が可能になります。",
