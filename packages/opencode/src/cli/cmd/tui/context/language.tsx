...
import { I18nProvider } from "@nexus-code/ui/context/i18n"
...
const loaders: Record<Exclude<Locale, "en">, () => Promise<Dictionary>> = {
  zh: () => merge(import("@nexus-code/ui/i18n/zh"), import("../i18n/zh")),
  zht: () => merge(import("@nexus-code/ui/i18n/zht"), import("../i18n/zht")),
  ko: () => merge(import("@nexus-code/ui/i18n/ko")),
  de: () => merge(import("@nexus-code/ui/i18n/de")),
  es: () => merge(import("@nexus-code/ui/i18n/es"), import("../i18n/es")),
  fr: () => merge(import("@nexus-code/ui/i18n/fr"), import("../i18n/fr")),
  da: () => merge(import("@nexus-code/ui/i18n/da")),
  ja: () => merge(import("@nexus-code/ui/i18n/ja"), import("../i18n/ja")),
  pl: () => merge(import("@nexus-code/ui/i18n/pl")),
  ru: () => merge(import("@nexus-code/ui/i18n/ru"), import("../i18n/ru")),
  ar: () => merge(import("@nexus-code/ui/i18n/ar")),
  no: () => merge(import("@nexus-code/ui/i18n/no")),
  br: () => merge(import("@nexus-code/ui/i18n/br")),
  th: () => merge(import("@nexus-code/ui/i18n/th")),
  bs: () => merge(import("@nexus-code/ui/i18n/bs")),
  tr: () => merge(import("@nexus-code/ui/i18n/tr")),
}
