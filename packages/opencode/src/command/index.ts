      ...
      commands[Default.DREAM] = {
        ...
        get template() {
          return [
            ...
            "$ARGUMENTS",
            "",
            "Use the memory files as the working index and the raw nexuscode trajectory database as the source of truth.",
      ...
      commands[Default.DISTILL] = {
        ...
        get template() {
          return [
            ...
            "Use the raw nexuscode trajectory database as the source of truth and memory files to spot cross-session patterns.",
